...
class UpdateDisputeStatus extends Notification 
{
    use Queueable;
    ...
    {
        // TODO Remove all database channels for messages to clients
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->level('info')
                    ->subject('TAARIFA YA SHAURI LAKO')
                    ->greeting('Habari!')
    ...
    {
        return [
            'message' => 'Dispute information updated  for '.$this->full_name.'.',
        ];
    }
}
