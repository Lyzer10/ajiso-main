...
use App\Exports\StaffDisputesExport;
...
class StaffExportController extends Controller
{
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = PDF::loadView('reports.staff.export-preview', [
                                                        'disputes' => $disputes,
                                                        'filter_by' => $filter_by,
    ...
    public function exportExcel(Request $request)
    {
        ...
        try {
            ...
            return Excel::download(new StaffDisputesExport($collection, $title), 'report_'.time().'.xlsx');
    ...
    public function exportCsv(Request $request)
    {
        ...
        try {
            // Download the excel file
            return Excel::download(new StaffDisputesExport($collection, $title), 'report_'.time().'.csv');
