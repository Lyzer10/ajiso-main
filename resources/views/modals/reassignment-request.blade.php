            ...
            <form method="POST" action="{{ route('dispute.request.store', app()->getLocale()) }}">
                ...
                <div class="modal-body">
                    ...
                    @if ($isAdminUser)
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label for="target_staff_id" class="font-weight-bold">{{ __('Reassign To') }}<sup class="text-danger">*</sup></label>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="reason_description" id="reason_description"
                                    ...
                                    placeholder="{{ __('Provide optional explanation for reassignment...') }}" rows="4">{{ old('reason_description') }}</textarea>
                    ...
                    {{-- PARALEGAL/STAFF FORM: Shows reason only --}}
                    @else
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="reason_description" id="reason_description"
                                    class="form-control border-text-primary @error('reason_description') is-invalid @enderror"
                                    placeholder="{{ __('Describe request reason here...') }}" rows="4" required>{{ old('reason_description') }}</textarea>
                                @error('reason_description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
