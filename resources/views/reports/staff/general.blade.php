        ...
        <div class="col-md-12 mt-5 mb-3">
                                ...
                                @if ($beneficiaries->count())
                                    @foreach ($beneficiaries as $beneficiary)
                                        <option value="{{ $beneficiary->beneficiary_id }}">
                                            {{ $beneficiary->reportedBy->user_no.' | '
                                                .$beneficiary->reportedBy->first_name.' '
                                                .$beneficiary->reportedBy->middle_name.' '
                                                .$beneficiary->reportedBy->last_name
                                            }}
                                        </option>
                                    @endforeach
                                @else
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-3">
                            <h4 class="header-title p-2 w-100 text-white dark-custom-color">
                                {{ __('Results Summary')}}
                            </h4>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <form action="{{ route('reports.export.pdf.staff', app()->getLocale()) }}" method="post">
                                        @csrf
                                    ...
                                    <form action="{{ route('reports.export.excel.staff', app()->getLocale()) }}" method="post">
                                        @csrf
                                        @foreach ($disputes as $dispute)
                                            <input type="hidden" name="dispute[]" value="{{ $dispute->id }}">
                                        @endforeach
                                    ...
                                    <form action="{{ route('reports.export.csv.staff', app()->getLocale()) }}" method="post">
                                        @csrf
                                        @foreach ($disputes as $dispute)
                                            <input type="hidden" name="dispute[]" value="{{ $dispute->id }}">
                                        @endforeach
