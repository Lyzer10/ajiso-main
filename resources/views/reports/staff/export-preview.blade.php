<h1 style="text-align: center;"><span style="color: blue;"><b>LA</b></span>iS</h1>
<h2 style="text-align: center;">Legal Aid System</h2>
<h3 style="text-align: center;">General Report</h3>
    @if ($disputes->count())
        <div>
            <h4 >
                {{ __('Results Summary')}}
        ...
        <div>
            <table order="1" width="100%" cellpadding="5">
                <thead style="background-color: blue;">
                    <tr>
                        <th width="5%">{{ __('Id') }}</th>
                        <th width="18%">{{ __('Dispute No') }}</th>
                        <th width="26%">{{ __('Service') }}</th>
                        <th width="11%">{{ __('Case') }}</th>
