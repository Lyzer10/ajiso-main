...
@section('breadcrumb')
    <div class="breadcrumbs-area clearfix">
        ...
        <ul class="breadcrumbs pull-left">
            ...
            @endcanany
            <li><span>{{ __('My Disputes List') }}</span></li>
        </ul>
    </div>
@endsection
                    ...
                    <div class="header-title clearfix">
                        @canany(['isStaff'])
                            ...
                            <form method="GET" action="{{ route('disputes.my.list', [app()->getLocale(), auth()->user()->staff->id]) }}" class="d-flex align-items-center pull-right mb-2">
                                ...
                                <select name="status" class="form-select form-select-sm me-2 border-prepend-black p-2 rounded small" onchange="this.form.submit()">
                        ...
                        @elsecanany(['isSuperAdmin', 'isAdmin', 'isClerk'])
                            {{ __('My Disputes List') }}
                            {{-- <a class="btn btn-sm btn-primary dropdown-toggle pull-right" href="#" id="bd-versions" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                {{ __('Add Dispute') }}
                            </a>
                            ...
                            <tbody>
                                @if ($disputes->count())
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ __($dispute->typeOfService->type_of_service) }}
                                        </td>
                                        <td>
