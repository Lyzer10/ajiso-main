                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span
                                                                    class="input-group-text  border-prepend-primary bg-prepend-primary"
                                                                    id="dispute">#</span>
                                                            </div>
                                                            <input type="text" class="form-control border-append-primary" id="disputeNo"
                                                                value="{{ $dispute->dispute_no }}" name="dispute_no" readonly
                                                                aria-describedby="dispute">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-3">
                                                        <label for="problem_description"
                                                            class="font-weight-bold">{{ __('Problem Description') }}</label>
                                                        <textarea class="form-control border-text-primary" readonly
                                                            name="problem_description" required
                                                            style="width: 100%;">{{ $dispute->problem_description }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-3">
                                                        <label for="beneficiary"
                                                            class="font-weight-bold">{{ __('Beneficiary') }}</label>
                                                        <input type="text" readonly class="form-control  border-input-primary"
                                                            id="beneficiary" value="{{ $dispute->reportedBy->user_no . ' | '
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-3">
                                                        <label for="type_of_service"
                                                            class="font-weight-bold">{{ __('Type of Service') }}</label>
                                                        <input type="text" readonly class="form-control  border-input-primary"
                                                            id="type_of_service" value="{{ $dispute->typeOfService->type_of_service }}">
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-3">
                                                        <label for="type_of_case"
                                                            class="font-weight-bold">{{ __('Type of Case') }}</label>
                                                        <input type="text" readonly class="form-control  border-input-primary"
                                                            id="type_of_case" value="{{ $dispute->typeOfCase->type_of_case }}">
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-3">
                                                        <label for="where_reported"
                                                            class="font-weight-bold">{{ __('Where did you report your problem?') }}</label>
                                                        <input type="text" readonly class="form-control  border-input-primary"
                                                            id="where_reported" value="{{ $dispute->where_reported }}">
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-3">
                                                        <label for="how_did_they_help"
                                                            class="font-weight-bold">{{ __('How did they help you?') }}</label>
                                                        <textarea class="form-control border-text-primary" readonly
                                                            name="how_did_they_help" id="how_did_they_help"
                                                            style="width: 100%;">{{ $dispute->how_did_they_help }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-3">
                                                        <label for="service_experience"
                                                            class="font-weight-bold">{{ __('Did you experience any inconvinience?') }}</label>
                                                        <textarea class="form-control border-text-primary" readonly
                                                            name="service_experience" id="service_experience"
                                                            style="width: 100%;">{{ $dispute->service_experience }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-3">
                                                        <label for="matter_to_court"
                                                            class="font-weight-bold">{{ __('Have you taken the matter to court?') }}</label>
                                                        <input type="text" readonly class="form-control  border-input-primary"
                                                            id="matter_to_court" value="{{ __($dispute->matter_to_court) }}">
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-3">
                                                        <label for="how_can_we_help"
                                                            class="font-weight-bold">{{ __('What do you want help with?') }}</label>
                                                        <textarea class="form-control border-text-primary" readonly
                                                            name="how_can_we_help" id="how_can_we_help"
                                                            style="width: 100%;">{{ $dispute->how_can_we_help }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-3">
                                                        <label for="defendant_names_addr"
                                                            class="font-weight-bold">{{ __('Names of people who will be monitored or prosecuted, and addresses') }}</label>
                                                        <textarea class="form-control border-text-primary" readonly
                                                            name="defendant_names_addr" id="defendant_names_addr"
                                                            style="width: 100%;">{{ $dispute->defendant_names_addr }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-footer">
                                                <a href="{{ route('dispute.edit', [app()->getLocale(), $dispute->id]) }}"
                                                    class=" btn btn-primary float-right">{{ __('Update Details') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                                            ...
                                                            @if ($occurrences->count())
                                                                <tbody>
                                                                    @foreach ($occurrences as $occurrence)
                                                                        <tr>
                                                                            <td scope="row">
                                                                                <a href="{{ route('dispute.show', [app()->getLocale(), $occurrence->id]) }}"
                                                                                    title="{{ __('View Dispute') }}">
                                                                                    {{ '#' . $occurrence->id }}
                                                                                </a>
                                                                            </td>
                                                                            <td>{{ Carbon\Carbon::parse($occurrence->reported_on)->format('d-m-Y') }}
                                                                            </td>
                                                                            <td>
                                                                                @php
                                                                            ...
                                                                            <td>
                                                                                @if (is_null($occurrence->staff_id))
                                                                                    @canany(['isSuperAdmin', 'isAdmin'])
                                                                                        <a href="{{ route('dispute.assign', [app()->getLocale(), $occurrence->id]) }}"
                                                                                            class="text-danger"
                                                                                            title="{{  __('Click to assigned legal aid provider') }}">
                                                                                            {{ __('Unassigned') }}
                                                                                        </a>
                                                                                ...
                                                                                @else
                                                                                                                        <a href="{{ route('staff.show', [app()->getLocale(), $occurrence->staff_id]) }}"
                                                                                                                            title="{{  __('Click to view assigned legal aid provider') }}">
                                                    ...
                                                    @if ($dispute->counselingSheets->count())
                                                        @foreach ($dispute->counselingSheets as $sheet)
                                                            <div class="alert alert-primary lead" role="alert">
                                                                ...
                                                                @endphp
                                                                {{ $duration . ' Hrs' }} |
                                                                <span @if ((bool) $sheet->is_open == true) class="text-success" @else
                                                                class="text-secondary" @endif>
                                                                    {{ (bool) $sheet->is_open == true ? 'Open' : __('Closed') }}
                                                                </span> |
                                                                <a
                                                                    href="{{ route('disputes.activity.sheet', [app()->getLocale(), $sheet->id]) }}">
                                                                    {{ __('View More') }}
                                                                </a>
                                                            </div>
                                                        @endforeach
