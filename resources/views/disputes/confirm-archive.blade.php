            ...
            <table class="table table-striped progress-table text-center">
                ...
                @if ($disputes->count())
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $dispute->typeOfCase->type_of_case }}
                        </td>
                        <td>
                        ...
                        <td>
                            @if (is_null($dispute->staff_id))
                                <a href="{{ route('dispute.assign', [app()->getLocale(), $dispute]) }}" class="text-danger" title="{{  __('Click to assign legal aid provider') }}">
                                    {{ __('Unassigned') }}
                                </a>
                            @else
                                <a href="{{ route('staff.show', [app()->getLocale(), $dispute->staff_id]) }}" title="{{  __('Click to view assign legal aid provider') }}">
