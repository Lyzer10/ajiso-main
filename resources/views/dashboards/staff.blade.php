                        ...
                        <div class="card cursor-pointer">
                            <div class="seo-fact sbg1">
                                <div class="p-4 d-flex justify-content-between align-items-center">
                                    <div class="seofct-icon"><i class="fas fa-archive"></i>{{ __('Assigned Disputes') }}
                                    </div>
                ...
                <div class="col-md-4 mt-md-5 mb-3">
                    <div class="card">
                        <div class="seo-fact sbg2">
                            <div class="p-4 d-flex justify-content-between align-items-center">
                                <div class="seofct-icon"><i class="fas fa-check-double"></i>{{ __('Resolved Disputes') }}
                                </div>
                ...
                <div class="col-md-4 mt-md-5 mb-3">
                    <div class="card">
                        <div class="seo-fact sbg4">
                            <div class="p-4 d-flex justify-content-between align-items-center">
                                <div class="seofct-icon"><i class="fas fa-sync-alt"></i>{{ __('Proceeding Disputes') }}
                                </div>
                                ...
                                @if ($disputes->count())
                                    @foreach ($disputes as $dispute)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a
                                                                    href="{{ route('beneficiary.show', [app()->getLocale(), $dispute->beneficiary_id]) }}">
                                ...
                                @else
                                    <tr>
                                        <td class="p-1" colspan="7">
                                            {{ __('No disputes associated to legal aid provider found') }}</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
