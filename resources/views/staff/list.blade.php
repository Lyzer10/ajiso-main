                    ...
                    <div class="header-title clearfix">{{ __('Legal Aid Providers List') }}
                        ...
                        <div class="dropdown pull-right mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="{{ route('staff.export.pdf', app()->getLocale()) }}{{ $exportQuery }}">
                                    <i class="fas fa-file-pdf text-danger"></i>
                                    {{ __('as pdf') }}
                                </a>
                                <a class="dropdown-item" href="{{ route('staff.export.excel', app()->getLocale()) }}{{ $exportQuery }}">
                                    <i class="fas fa-file-excel text-success"></i>
                                    {{ __('as excel') }}
                                </a>
                                <a class="dropdown-item" href="{{ route('staff.export.csv', app()->getLocale()) }}{{ $exportQuery }}">
